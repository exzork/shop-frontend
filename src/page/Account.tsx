                ...
                <div className='lg:ml-12 ml-0 my-8 flex flex-grow md:overflow-y-auto lg:h-[80vh]'>
                    {isLoading ? (
                        <div className="flex justify-center items-center w-full">
                            <div className="text-gray-500 text-lg">Loading accounts...</div>
                        </div>
                    ) : !accounts || accounts.length === 0 ? (
                        <div className="flex flex-col items-center justify-center w-full bg-white rounded-lg shadow-md p-8">
                            <svg className="w-16 h-16 text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            <h3 className="text-xl font-semibold text-gray-700 mb-2">No Accounts Available</h3>
                                        ...
                                        <div className="flex md:flex-row flex-col justify-between md:items-center items-start">
                                            ...
                                            <div className="flex items-center gap-2">
                                                {isAuthenticated ? (
                                                    ...
                                                    }}>Buy ({formatCurrency(item.price)})</button>
                                                )}
                                            </div>
                                        </div>
